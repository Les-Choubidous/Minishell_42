...
// 	if (!commands->arg)
// 		path = find_env_value(data->full_env, "HOME");
// 	else if (!ft_strcmp(commands->arg->value, "-"))
// 	{
// 		path = find_env_value(data->full_env, "OLDPWD");
// 		if (!path)
// 		{
...
// /**
//  * @brief Met à jour une variable d'environnement dans un tableau de chaînes.
//  *
//  * @param env Le tableau d'environnement à modifier.
//  * @param key La clé de la variable à mettre à jour.
...
// // 	//new_entry = join_key_val(key, value);
// // 	// if (!new_entry)
// // 	// 	return (EXIT_FAILURE);

// // 	free(data->full_env[i]);
// // 	data->full_env[i] = new_entry;
// // 	return (EXIT_SUCCESS);
// // }
...
// 	old_pwd_index = find_env_index(data->full_env, "OLDPWD");
// 	new_pwd_index = find_env_index(data->full_env, "PWD");
